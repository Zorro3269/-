...
void OLED_ShowString_6x8(uint8_t Line, uint8_t Column, char *String)
{
	...
	for (i = 0; String[i] != '\0'; i++)
	{
		OLED_ShowChar_6x8(Line, Column + i, String[i]);
	}
}
